...
<head>
    <meta charset="UTF-8">
    <title>Update Staff - Admin</title>
    ...
    <div class="card">
        <div class="card-header update-header">
            <div class="header-main">
                ...
                <div class="header-text">
                    ...
                    <p class="subtitle mb-0">Update staff account information</p>
                </div>
            </div>
        ...
        <div class="card-body">
            ...
            <div class="alert alert-danger" role="alert">
                <i class="fas fa-exclamation-circle me-1"></i><%= request.getAttribute("errorMessage") %>
            </div>
            <% } %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date"
                                   ...
                                   name="birthDate"
                                   class="form-control"
                                   value="<%= staff.getBirthDay() != null ? staff.getBirthDay().toString() : "" %>">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date"
                                   ...
                                   name="hiredDate"
                                   class="form-control"
                                   value="<%= staff.getHiredDate() != null ? staff.getHiredDate().toString() : "" %>"
                                   required>
                        </div>
                    </div>
                </div>
