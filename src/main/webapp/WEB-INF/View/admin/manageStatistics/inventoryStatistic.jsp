...
<html>
    <head>
        ...
        <style>
            ...
            .low-stock { background-color: #facc15; color: #1f2937; }
                ...
                <main class="main-content">
                   ...
                   <div class="stats-table-card">
                        <div class="table-responsive">
                            <table class="stats-table" aria-label="Inventory table">
                                <thead>
                                    <tr>
                                        <th>Import ID</th>
                                        <th>Category</th>
                                ...
                                <tbody>
                                    ...
                                    %>
                                    <tr>
                                        <td colspan="11" class="text-center py-3">No inventory data found.</td>
                                    </tr>
                                    <% } %>
                                </tbody>
                            </table>
