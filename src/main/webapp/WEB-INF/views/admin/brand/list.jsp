    ...
    <main class="flex-grow-1 p-4">
      <div class="d-flex align-items-center justify-content-between">
        ...
        <a class="btn btn-primary"
           href="<%= ctx %>/Admin/BrandManagement?action=create">
          + Create Brand
        </a>
      </div>
                ...
                <tr>
                  ...
                  <td>
                    <% if (logo != null && !logo.trim().isEmpty()) { %>
                      <img src="<%= logo %>" alt="logo" style="height:44px; max-width:160px; object-fit:contain;">
                    <% } else { %>
                  ...
                  <td class="text-end">
                    <a class="btn btn-sm btn-outline-primary"
                       href="<%= ctx %>/Admin/BrandManagement?action=update&id=<%= b.getBrandID() %>">
                      Update
                    </a>
