...
<%
    ...
    // Ưu tiên session "customer", fallback "user" để khỏi vỡ nếu login cũ
    ...
    <div class="header-top d-flex align-items-center justify-content-between">
                    ...
                    <%
                        if (categoryList != null) {
                            for (Category cate : categoryList) {
                                // DAO đã lọc IsDeleted=0, nhưng giữ thêm check an toàn
                                if (Boolean.TRUE.equals(cate.getIsDeleted())) continue;
                    %>
        ...
        <div class="search-wrapper mx-3 position-relative flex-grow-1">
            <form action="${pageContext.request.contextPath}/SearchProduct" method="get"
                ...
                <input type="text" name="keyword" class="form-control" style="padding-right: 40px;">
                <button type="submit"
        ...
        <div class="header-right d-flex align-items-center gap-2">
            ...
            <a href="${pageContext.request.contextPath}/CartList?accountId=<%= (customer != null ? customer.getCustomerID() : 0) %>"
               class="btn btn-outline-dark" title="Giỏ hàng">
                <i class="bi bi-cart"></i>
            </a>
        </div>
    </div>
