...
protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    if (action.equalsIgnoreCase("list")) {
        ...
        request.getRequestDispatcher("WEB-INF/View/staff/customerManagement/customerList.jsp")
        ...
        try {
            ...
            request.getRequestDispatcher("WEB-INF/View/staff/customerManagement/view-customer-detail.jsp")
                   .forward(request, response);
            return;
        ...
        try {
            ...
            response.sendRedirect("CustomerList" + (success ? "" : "?error=UpdateFailed"));
            return;

        } catch (NumberFormatException e) {
            response.sendRedirect("CustomerList?error=InvalidID");
            return;
        }
    }
        ...
        if (keyword != null && !keyword.trim().isEmpty()) {
            list = dao.searchCustomerByName(keyword.trim());
        } else {
